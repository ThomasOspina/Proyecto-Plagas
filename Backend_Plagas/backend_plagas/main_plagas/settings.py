"""
Django settings for backend_plagas project.
...
SECRET_KEY = 'django-insecure-p_ngb_@c@l#d3ipz=t*3y(u3fos(9+x5wj5v=z@)l%#o+du0h%'
...
WSGI_APPLICATION = 'main_plagas.wsgi.application'
